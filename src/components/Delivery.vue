...
<template>
<form @submit.prevent="createOrder" class="p-6 pb-25 bg-[#ede0d4] rounded-xl m-2 relative h-full">

<h2 class="text-[#7f5539] text-3xl md:text-center font-[Futura] mb-6 px-16 py-2 relative">
...
<label class="inline-block w-full md:w-1/5 p-2 mt-4 md:my-3 md:text-right after:text-red-500 after:content-['*'] md:w-1/5">Дом</label>
...
<label class="inline-block w-full md:w-1/5 p-2 mt-4 md:my-3 md:text-right md:w-1/5">Корпус</label>
...
<label class="inline-block w-full md:w-1/5 p-2 mt-4 md:my-3 md:text-right md:w-1/5">Строение</label>
...
<label class="inline-block w-full md:w-1/5 p-2 mt-4 md:my-3 md:text-right">Квартира</label>
