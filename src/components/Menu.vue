...
<button @click="router.push(`/menu/${item.cat}`)" :style="{backgroundImage: 'url('+item.image+')'}" class="bg-top bg-[100%_auto] rounded-xl m-2 w-xs h-[230px] relative hover:scale-120 origin-center transition duration-500 linear hover:z-100">
