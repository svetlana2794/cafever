...
<p :class="[storeCart.total>=1500 ? 'visible' : 'invisible', 'm-2', 'mb-4', 'text-center']">Стоимость доставки: {{storeCart.total < 2000 ? "250 руб." : "бесплатно"}}</p>

<button :disabled="storeCart.total<1500" @click="router.push('/client')" class="block p-4  mb-2 mt-6 mx-auto bg-[#b23a46] hover:bg-[#da1e37] text-white md:w-1/2 text-center rounded-full disabled:bg-[#e6ccb2] disabled:text-black">Перейти к оформлению заказа</button>
